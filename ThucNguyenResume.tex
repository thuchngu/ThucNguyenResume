...
\vspace{-.75em}
\subsection{Familiar}
Java, Verilog, FPGA, PADS Designer, Xilinx Vivado, VHDL, SPICE, CUDA, EAGLE, Atmel Studio, MATLAB, LaTex
...
Associate Scientist in the Physical Sciences and Systems Department of Raytheon BBN Technologies located in Cambridge, MA, working mainly in an embedded software engineering capacity.
\vspace{-.75em}
